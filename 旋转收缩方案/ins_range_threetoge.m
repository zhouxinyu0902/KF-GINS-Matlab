...
% cfg = ProcessConfigforSemiPhy2();
cfg = ProcessConfigforSemiPhy3();
% cfg = ProcessConfigforSimu('旋转收缩方案/input_simu4');
...
calc_radial_error(cfg.truthpath,path_EKF,path_AEKF,path_BRC_AEKF,path_GTS_BRC_AEKF)
hold on
