...
function cfg = ProcessConfigforSimu(filepath)
    param = Param();
    %% filepath
    if filepath(end)=='1'
        cfg.outputfolder ='旋转收缩方案/output_simu1';
    elseif filepath(end)=='2'
        cfg.outputfolder ='旋转收缩方案/output_simu2';
    elseif filepath(end)=='3'
        cfg.outputfolder ='旋转收缩方案/output_simu3';
    elseif filepath(end)=='4'
        cfg.outputfolder ='旋转收缩方案/output_simu4';
    else
        cfg.outputfolder ='旋转收缩方案/output_simu';
    end
    cfg.imufilepath = [filepath,'/IMU_120.txt'];
    % cfg.imufilepath = '旋转收缩方案/input_simu/IMU_120_005.txt';
    % cfg.imufilepath = '旋转收缩方案/input_simu/IMU_120_0005.txt';
    % cfg.imufilepath = '旋转收缩方案/input_simu/IMU_120_0003.txt';
