...
%%
output_file  = ['D:\Github\KF-GINS-Matlab\',path,'\rangedata', '.txt'];
try
...
output_file  = ['D:\Github\KF-GINS-Matlab\',path,'\height', '.txt'];
try
...
%%
% calc_error([cfg.outputfolder,'/EKF.nav'],cfg.truthpath)
path='D:\Github\KF-GINS-main\dataset_exper2\KF_GINS_Navresult.nav';
truthpath='D:\Github\KF-GINS-main\dataset_exper2\truth.nav';
path1='D:\Github\KF-GINS-Matlab\旋转收缩方案1\output2\AEKF.nav';
calc_radial_error(truthpath,path1,path)
%%
