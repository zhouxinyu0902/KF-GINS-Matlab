function cfg = ProcessConfigsimu_10()

    param = Param();

    %% 文件读取
    cfg.imufilepath = 'simu_5_29/input/imu.nav';
    cfg.LBLfilepath = 'simu_5_29/input/LBL.nav';
    cfg.depthfilepath = 'simu_5_29/input/depth-nav.nav';
    cfg.rangefilepath = 'simu_5_29/input/range_3beacon_1s.txt';
    cfg.outputfolder = 'simu_5_29/output';
    cfg.truthpath='simu_5_29/input/truth.nav';
    %% 初始信息
    cfg.starttime = 0;
    cfg.endtime = 0+3625;
    ...
    cfg.initaccbiasstd = [10; 10; 10]; % [mGal]
    ...
    cfg.accbiasstd = 10; % [mGal] 加速度计零偏标准差
