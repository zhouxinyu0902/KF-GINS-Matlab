function cfg = patent_Configsimu()

    param = Param();
    glvs
    %% 文件读取
    cfg.imufilepath = '专利实验/input/line-imu.nav';
    % cfg.LBLfilepath = '专利实验/input/LBL.nav';
    % cfg.depthfilepath = '专利实验/input/depth-nav.nav';
    cfg.rangefilepath = '专利实验/input/line-range.nav';
    cfg.rangefile1path = '专利实验/input/line-range1.nav';
    cfg.rangefile2path = '专利实验/input/line-range2.nav';
    cfg.rangefile3path = '专利实验/input/line-range3.nav';
    cfg.outputfolder = '专利实验/output';
    cfg.truthpath='专利实验/input/line-truth.nav';
    %% 初始信息
    cfg.starttime = 0;
    cfg.endtime = 0+7200;
