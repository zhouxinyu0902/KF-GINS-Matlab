% 提取和整理数据 (单位: m)
% 排除 pureins，只比较 EKF, AEKF, BRC+AEKF, GTS+BRC+AEKF
...
System_Labels = {'PureIns', 'EKF', 'AEKF', 'BRC+AEKF', 'GTS+BRC+AEKF'};
Scenario_Labels = {'Scenario 1', 'Scenario 2', 'Scenario 3', 'Scenario 4'};
...
Max_Error_Data = [
    ...
    184.91, 107.03, 268.31, 158.31;     % BRC+AEKF
    99.78, 59.21, 116.37, 64.25         % GTS+BRC+AEKF
...
RMS_Error_Data = [
    ...
    78.12, 40.99, 77.10, 58.07;         % BRC+AEKF
    34.35, 21.68, 47.10, 26.76          % GTS+BRC+AEKF
]'; % 转置后，行代表场景，列代表系统 (为 bar(X) 准备)
...
RMS_Improvement = [
    ...
    94.59, 96.74, 94.89, 95.60;  % BRC+AEKF
    97.62, 98.27, 96.88, 97.98   % GTS+BRC+AEKF
]; 
...
StepUp_Improvement_EKF_Basis = [
    ...
    62.65, 69.61, 64.51, 65.20;  % BRC+AEKF vs EKF
    83.50, 83.92, 78.32, 83.95   % GTS+BRC+AEKF vs EKF
];
