...
% FR-IFA AEKF RMS:[59.94, 122.54, 77.77, 235.62]
% FFBS-Fusion RMS: [45.44, 81.59, 41.54, 184.53]
...
StepUp_Improvement_EKF_Basis = [
    ...
    (1 - RMS_BRC_AEKF ./ RMS_EKF) * 100;       % FR-IFA AEKF vs EKF
    (1 - RMS_GTS_BRC_AEKF ./ RMS_EKF) * 100    % FFBS-Fusion vs EKF
];
