...
% ==================== 1. 基础配置 ====================
base_output_dir = topic_paths.figures_tables;
summary_dir = fullfile(base_output_dir, 'summary');
...
for id = target_rounds
    excel_path = fullfile(base_output_dir, sprintf('dataset%d', id), ...
...
% ==================== 4. 保存汇总大图 ====================
output_image_path = fullfile(summary_dir, ...
    sprintf('8组数据误差汇总对比图-%s.png', unitType));
