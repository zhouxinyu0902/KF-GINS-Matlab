...
beacon  = importdata(cfg.beaconpath);    % t slant horizontal beacon_lat beacon_lon beacon_h
...
% 输出文件
origin_nav_path = fullfile(cfg.outputfolder, 'Origin-DR.nav');
fused_nav_path  = fullfile(cfg.outputfolder, 'DR-RANGE.nav');
...
%%
drpath= fullfile(cfg.outputfolder, 'Origin-DR-ned.txt');
drrangepath = fullfile(cfg.outputfolder, 'DR-RANGE-ned.txt');
