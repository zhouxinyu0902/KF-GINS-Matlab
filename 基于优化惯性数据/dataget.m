...
clc
glvs
truth=importdata("基于优化惯性数据\input\truth.nav");
fprintf("参考结果的频率：%.2f Hz\n",1/(truth(2,2)-truth(1,2)))
% 输出文件夹
outputpath='基于优化惯性数据\input';
...
dxyz_original = [0, 200, 0;
                ...
                100, 100, 0;
                -200, 0, 0];
beaconums=length(dxyz_original);
% 定义旋转角度（15度）
theta_deg = 0;
