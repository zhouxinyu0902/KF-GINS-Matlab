...
%% 临界长度
% 您提供的公式： L = 1.17 * R1 * 2 * sqrt(R1 * 2 / thickness)
...
% 根据我们之前的讨论，圆筒的长径比为 h/R1/2 = 50/40 = 1.25，属于中等长度，
% 这也解释了为什么长圆筒和短圆筒公式会给出不同结果。
...
L_cylinder_mm = h * 10; % 圆筒长度 (mm)

pp = 2.6 * E * (S_wall_mm / D_outer_mm)^2.5 / (L_cylinder_mm / D_outer_mm);
