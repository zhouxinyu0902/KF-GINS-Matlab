...
if saveFig
    exportgraphics(gcf, ...
        fullfile(saveFolder, '三组实验_平均水平误差改善率对比+平均水平误差对比.png'), ...
        'Resolution', figDpi);
end
...
if saveFig
    exportgraphics(gcf, ...
        fullfile(saveFolder, '三组实验_逐潜标水平误差对比.png'), ...
        'Resolution', figDpi);
end
...
if saveFig
    exportgraphics(gcf, ...
        fullfile(saveFolder, '三组实验_第一轮角度误差与位移偏差估计误差合并图.png'), ...
        'Resolution', figDpi);
end
...
if saveFig
    exportgraphics(gcf, ...
        fullfile(saveFolder, '三组实验_逐潜标第一轮位移偏差估计误差.png'), ...
        'Resolution', figDpi);
end
...
if saveFig
    exportgraphics(gcf, ...
        fullfile(saveFolder, '三组实验_第一轮真实位移偏差与估计位移偏差对比.png'), ...
        'Resolution', figDpi);
end
