...
for ii = 1:numel(baseFolders)
    ...
    inputFolder  = fullfile(baseFolder, 'input_stage1');
    ...
    if id == 2
        ...
        inputFolder2  = fullfile(baseFolder, 'input_stage2');
        originalRangePaths = { ...
            fullfile(inputFolder2, 'range1.txt'), ...
            fullfile(inputFolder2, 'range2.txt'), ...
            fullfile(inputFolder2, 'range3.txt')};
        outputFiles = range_reconstruct1( ...
            originalRangePaths, ...
            pathpos, ...
            inputFolder2, ...
