...
function cfg = ProcessConfig_MEMS_exper(path)
    ...
    % cfg.truthpath = [path,'/input','/pva_file.txt'];
    %% configure
    ...
    % cfg.initgyrbiasstd = [0.27; 0.40; -0.04]; % [deg/h]
    % cfg.initaccbiasstd = [20; -10; -100]; % [mGal]
    % 过程噪声
    ...
    % 不相关参数
    cfg.initgyrscalestd = [100; 100; 100]; % [ppm]
    cfg.initaccscalestd = [100; 100; 100]; % [ppm]

    cfg.gyrscalestd = 100; % [ppm] 刻度系数标准差
    cfg.accscalestd = 100; % [ppm] 
