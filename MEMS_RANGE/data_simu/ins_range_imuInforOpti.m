...
cfg = ProcessConfig_imusimu(path);
...
%%
path1=[path,'/MEMS-single-none.nav'];
path2=[path,'/MEMS-single-opti-200.nav'];
path3=[path,'/MEMS-single-opti-300.nav'];
...
%%
pureins=[path,'/MEMS-PureIns.nav'];
path1=[path,'/MEMS-single-EKF.nav'];
path2=[path,'/MEMS-moving-circle-EKF.nav'];
path3=[path,'/MEMS-moving-trjlike-EKF.nav'];
path4=[path,'/MEMS-moving-trjsquare-EKF.nav'];
