...
%% 路径配置：第三批 run-0818-noon
script_dir = fileparts(mfilename('fullpath'));
topic_dir = fileparts(script_dir);
addpath(topic_dir, '-begin');
paths = setup_all_real_data_preprocessing('run-0818-noon');
rootDir = paths.raw;
%% =========================================================
% 1. 读取 830 数据
%% =========================================================
file='081325_4752450';
filename  = fullfile(rootDir, [file,'.dat']);
filename1 = fullfile(rootDir, [file,'_GPCHCX.dat']);
filename2 = fullfile(rootDir, [file,'_GPGGA.dat']);
