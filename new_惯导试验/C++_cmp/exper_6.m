...
for smoothWay = "RTS"
    ...
    writematrix(rangedata, 'D:\Github\KF-GINS-main\dataset_exper6\input\rangedata_noised.txt', 'Delimiter', 'space'); % 空格
    writematrix(height, 'D:\Github\KF-GINS-main\dataset_exper6\input\height_noised.txt', 'Delimiter', 'space'); % 空格
    %% 计算并提取添加的误差
    % % 提取时间轴
