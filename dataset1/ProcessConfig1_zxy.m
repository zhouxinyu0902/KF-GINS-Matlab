function cfg =ProcessConfig1_zxy()
    param = Param();
    %% filepath
    cfg.imufilepath = 'dataset1/input/Leador-A15.txt';
    cfg.gnssfilepath = 'dataset1/input/GNSS-RTK.txt';
    cfg.depthfilepath = 'dataset1/input/height-1Hz.txt';
    cfg.depthfile1path = 'dataset1/input/height-200Hz.txt';
    cfg.rangefile1path = 'dataset1/input/range_static_1.txt';
    cfg.rangefile2path = 'dataset1/input/range_static_2.txt';
    cfg.rangefile3path = 'dataset1/input/range_static_3.txt';
    cfg.rangefile4path = 'dataset1/input/range_static_4.txt';
    cfg.rangefile5path = 'dataset1/input/range_moving.txt';
